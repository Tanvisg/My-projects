...
def createdb():
    ...
    if p1 == p2:
        ...
        mycurr.execute("use miniproject")
...
def createdbup():
    ...
    mycurr2.execute("use miniproject")
...
def createfeed():
    ...
    mycurr4.execute("use miniproject")
...
def createdbvacancy():
    ...
    mycurr1.execute("use miniproject")
...
def viewC():
    ...
    lh = Label(rootvi, text="s.no\tFullname\tUsername\tEmail_ID\tPhoneNumber\tExperiences\tPassword(default)",
               font=('arial', 14), bg="black", fg="white", width=100)
    lh.place(x=100, y=75)
...
def viewfeed():
    ...
    lv.place(x=130, y=40)
    lh = Label(root3, text="Email Id\t\tquery", font=('arial', 14),bg="black", fg="white", width=60)  
    lh.place(x=100, y=75)
    myconn = mysc.connect(host="localhost", user="root", passwd="Tanvi@03")
    mycurr = myconn.cursor()
    mycurr.execute("use miniproject")
...
def addV():
    ...
    # lb3.place(x=0, y=0, relwidth=1, relheight=1)
    # ===================LABELS==============================
    lbl_title = Label(rootv, text="ADD VACANCY", font=('arial', 16), width=30)
    lbl_title.grid(row=0, column=0, columnspan=2)
    lbl_comp = Label(rootv, text="Company", font=('arial', 14), bd=5)
    lbl_comp.grid(row=2, sticky=W)
    lbl_indus = Label(rootv, text="Industry", font=('arial', 14), bd=5)
    lbl_indus.grid(row=3, sticky=W)
    lbl_role = Label(rootv, text="Role", font=('arial', 14), bd=5)
    lbl_role.grid(row=4, sticky=W)
    lbl_skill = Label(rootv, text="Place", font=('arial', 14), bd=5)
    lbl_skill.grid(row=5, sticky=W)
    lbl_field = Label(rootv, text="Field", font=('arial', 14), bd=5)
    lbl_field.grid(row=6, sticky=W)
    lbl_exper = Label(rootv, text="Experiences", font=('arial', 14), bd=5)
    lbl_exper.grid(row=7, sticky=W)
    lbl_skill = Label(rootv, text="Skills Required", font=('arial', 14), bd=5)
...
def updateC():
    ...
    # img11 = ImageTk.PhotoImage(Image.open("977c2e8c480428e79cc15cdffdda95ad.jpg"))
    # lb3 = Label(rootup, image=img11)
    # lb3.image = img11
    # lb3.place(x=0, y=0, relwidth=1, relheight=1)

    lbl_title = Label(rootup, text="Update Details", font=('arial', 16), width=30)
    lbl_title.grid(row=0, column=0, columnspan=2)
    lbl_firstname = Label(rootup, text="Update for", font=('arial', 14),bd=5)
...
def addM():
    ...
    # ===================LABELS==============================
    lbl_title = Label(addform, text="ADD EMPLOYEE DETAILS", font=('arial', 16),  width=30)
    lbl_title.grid(row=0, column=0, columnspan=2)
...
def admin():
    ...
    b1 = Button(root2, text="Update Candidate's details",command=updateC, width=20, bg='black', fg='white', font=('arial', 14)
                )
    b2 = Button(root2, text="View Employee Details", width=20, bg='black',command=viewC, fg='white', font=('arial', 14)
                )
    b3 = Button(root2, text="Add Vacancy", bg='black', command=addV, width=25, fg='white', font=('arial', 14) )
    b4 = Button(root2, text="View feedback and help", width=20, bg='black',command=viewfeed, fg='white', font=('arial', 14)
             )
...
# creating and connecting database for apllay ofr job
def create2():
    conn = sqlite3.connect('database.db')
    c = conn.cursor()
    c.execute(
